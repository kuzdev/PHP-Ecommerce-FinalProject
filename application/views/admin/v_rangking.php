            ...
            <div class="col-xl-12 col-lg-12 col-md-6">
                <div class="card m-b-30">
                    <div class="card-body">
                        ...
                        <h4 class="mt-0 header-title">Kesimpulan</h4>
                        ...
                        <ul class="nav nav-tabs" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link active" data-toggle="tab" href="#home" role="tab">Lihat Semua
                                    Data</a>
                            </li>
                            
                            <li class="nav-item">
                                <a class="nav-link" data-toggle="tab" href="#profile" role="tab">Normalisasi</a>
                            </li>
                            
                            <li class="nav-item">
                                <a class="nav-link" data-toggle="tab" href="#matrikx" role="tab">Hasil Perangkingan</a>
                            </li>
                        ...
                        <div class="tab-content">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <button type="button" class="btn btn-warning" data-toggle="modal" data-target="#myModal1"><i class="mdi mdi-lead-pencil font-weight-bold"></i></button>
                                                ...
                                                <button type="button" class="btn btn-danger" id="sa-warning"><i class="mdi mdi-delete font-weight-bold"></i>
                                                </button>
                                            </td>
                                        </tr>
                                    </tbody>
                            ...
                            <div class="tab-pane p-3" id="profile" role="tabpanel">
                                ...
                                <h4 class="mt-0 header-title">Hasil Perangkingan</h4>
                            ...
                            <div class="tab-pane p-3" id="matrikx" role="tabpanel">
